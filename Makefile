...
webbrowser.open(r'file://wsl%24/Ubuntu-20.04/home/sam/image_slicer/docs/_build/html/index.html')
endef
...
gen-docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/image_slicer*.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ image_slicer **/tests/
	$(MAKE) -C docs html
